...
# Bước 4: Khởi tạo mô hình Random Forest và huấn luyện
...
# Bước 7: Lưu mô hình sau khi huấn luyện
joblib.dump(model, 'training/RandomForest/random_forest_model.pkl')  # Lưu mô hình vào file
